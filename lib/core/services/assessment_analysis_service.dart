...
class AssessmentAnalysisService {
  ...
  static List<String> _getAutismRecommendations(
    ...
    recommendations.add('👨‍⚕️ تقييم شامل من متخصص في الحالات النمائية');
    recommendations.add('👥 العلاج السلوكي أو العلاج الاجتماعي إن وجد');

    if (socialScore >= 10) {
      recommendations.add('🗣️ تدريب مهارات التواصل الاجتماعي');
      recommendations.add('👁️ العمل على مهارات فهم تعابير الوجه والإيماءات');
    }
